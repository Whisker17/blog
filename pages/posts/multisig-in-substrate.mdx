---
slug: multisig-in-substrate
title: MultiSig in Substrate
date: 2023-04-03
description: This blog explores how MultiSig works in Substrate.
...
- `deposit`, which is the amount of money reserved by the depositor to start the multisig operation and will be refunded when the multisig is completed
  ...
  - The design of the reserve amount will be similar to that of the transaction fee:
    $$TotalFee = DepositBase + DepositFactor \* Threshold$$
...
![MultiSig Operate function workflow](/images/blog/multisig-in-substrate.png)
