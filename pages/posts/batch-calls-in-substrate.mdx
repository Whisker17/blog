---
slug: batch-calls-in-substrate
title: Batch calls in Substrate
date: 2023-04-18
description: The article explains how Substrate's batch calls functionality allows users to execute multiple transactions with a single signature through the utility.batch method, improving user experience by reducing the number of required signatures while maintaining security.
